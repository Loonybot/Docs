...
3. It captures a ton of data every time you run an opMode that can be examined later.

It's comprised of two components:

1. A **library** that you include in your team's robot code. The library is responsible for:
...
2. A PC **application** that you install on your laptop. The application is used for:
